...
describe('generator-alfresco:webscript-3-0-1', function () {
  this.timeout(30000);
  ...
  describe('after creating java webscripts', function () {
    before(function () {
      return helpers.run(path.join(__dirname, '../generators/webscript'))
        ...
        .withOptions({
          ...
          'module-path': 'temp-test-platform-jar',
          'id': 'java',
    ...
    it('amp files exist in project', function () {
      assert.file([
        ...
        osTempDir, 'temp-test-platform-jar/src/main/resources/alfresco/extension/templates/webscripts/org/alfresco', relativePath)));
      ...
      assert.file([
        ...
        osTempDir, 'temp-test-platform-jar/src/main/resources/alfresco/module/temp-test-platform-jar/context/generated', relativePath)));
      ...
      ].map(relativePath => path.join(osTempDir, 'temp-test-platform-jar/src/main/java/org/alfresco/webscripts', relativePath)));
    });
  });
