...
describe('generator-alfresco:jsroot-2-1-1', function () {
  ...
  describe('with simple 2.1.1 project', function () {
    ...
    describe('when creating class file with two words', function () {
      const jsRootJavaFile = path.join(osTempDir, 'repo-amp/src/main/java/org/alfresco/jsroot/Hello.java');
    ...
    describe('when creating root object with CamelCase name', function () {
      const jsRootJavaFile = path.join(osTempDir, 'repo-amp/src/main/java/org/alfresco/jsroot/CamelRoot.java');
    ...
    describe('when creating root object using package that does not end with .jsroot', function () {
      const jsRootJavaFile = path.join(osTempDir, 'repo-amp/src/main/java/org/alfresco/jsroot/Testroot.java');
    ...
    describe('when creating root objects with prompts', function () {
      const jsRootJavaFile = path.join(osTempDir, 'repo-amp/src/main/java/org/alfresco/jsroot/Prompt.java');
