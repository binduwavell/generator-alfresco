...
class ModuleAddLocalSubGenerator extends SubGenerator {
  ...
  prompting () {
    // SDK 3 doesn't currently support the (scope:system, systemPath) trick for referencing
    // local artifacts. So we either need to update the SDK or we need to update this generator
