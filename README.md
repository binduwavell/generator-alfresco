...
You get to choose what type of application you wish to create, such as a Backbone application or even a Chrome extension.
This project provides a generator for create Alfresco extensions.
...
We have not pushed a version of generator-alfresco to npmjs.org yet, so you need to clone this project and then:
...
As the workspace is temporary, don't forget to persist it if you want to access your work for later.
